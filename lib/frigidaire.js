 ...
 */
 ...
 function Frigidaire(options) {
     ...
     this.userAgent = opts.userAgent || 'Frigidaire/81 CFNetwork/1206 Darwin/20.1.0';
     this.basicAuthToken = opts.basicAuthToken || 'Gsdwexj38r1sXSXIPVdxj4DGoU5ZoaI6aW6ZckBI';
